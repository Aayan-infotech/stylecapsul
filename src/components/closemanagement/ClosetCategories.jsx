          ...
          <div className="mt-4">
            ...
            <div className="row">
              <div className="col-12">
                <div className="card-section p-3 d-flex flex-column">
                  {['xxx7676x77897', 'xxx7676x77897', 'xxx7676x77897'].map((card, index) => (
                    <div key={index} className="card-item d-flex justify-content-between align-items-center mb-2">
                      <div>{card}</div>
            ...
            <div className="row social-icons">
              <div className="col text-center">
                <a href="https://www.facebook.com/discountDoor/" target="_blank" rel="noopener noreferrer">
