            ...
            cardContent: [
                {
                    ...
                    imageUrl: "https://img.freepik.com/free-photo/medium-shot-romantic-couple-with-plaid-blanket_23-2150561506.jpg"
                },
                {
                    title: "Headline: 32 characters",
                    text: "Description: 18 characters",
                    imageUrl: "https://www.stylecraze.com/wp-content/uploads/2013/06/Different-Beautiful-American-Girls.jpg"
                },
                {
                    title: "Headline: 32 characters",
                    text: "Description: 18 characters",
                        ...
                        <div className="col-12">
                            <div className="p-3 border-1 text-black" style={{ backgroundColor: "#f5f5f56e" }}>
                                <div className="d-flex justify-content-between align-items-center">
                                    <div className="d-flex justify-content-between align-items-center">
                                        <Avatar alt={post.userName} sx={{ width: 56, height: 56 }} className='me-3' src={post.avatarUrl} />
                                        <div className='text-black'>
                                            <h5 style={{ lineHeight: '1.2' }}>{post.userName}</h5>
                                            <h6 style={{ fontSize: "13px" }}>{post.postDate} • <i className="fa-solid fa-earth-americas"></i></h6>
                                        </div>
                                    </div>
                                    <div><i className="fa-solid fa-ellipsis-vertical fs-4 text-black"></i></div>
                                </div>
                                <div className="text-black mt-2">
                                    <p className='fw-bold'>{post.postContent}</p>
                                    <a href="#" className="text-decoration-none">{post.hashtags}</a>
                                </div>

                                <div className='d-flex mt-3'>
                                    {post.cardContent.map((card, cardIndex) => (
                                        <div className="card me-3 text-black" style={{ width: "18rem", backgroundColor: "#e8e8e8" }} key={cardIndex}>
                                            <img src={card.imageUrl} className="card-img-top" height={300} alt="..." />
                                ...
                                <div className="d-flex justify-content-between align-items-center">
                                    <div className="d-flex justify-content-between align-items-center">
                                        <div className='d-flex align-items-center text-black'>
                                            <ThumbUpIcon onClick={() => handleLike(index)} className='fs-5 me-3' color={post.liked ? 'primary' : 'inherit'} />
                                ...
                                <div className="d-flex justify-content-evenly align-items-center text-black">
                                    <h5 onClick={() => handleLike(index)} style={{ cursor: "pointer" }}>
                                        <i className="fa-regular fa-thumbs-up me-2"></i> Like
                                    </h5>
                                    <h5 onClick={() => toggleCommentSection(index)} style={{ cursor: "pointer" }}>
                                        <i className="fa-regular fa-comment me-2"></i> Comment
                                    </h5>
                                    <h5 onClick={() => handleShare(index)} style={{ cursor: "pointer" }}>
                                ...
                                {post.showComments && (
                                    <div className="comment-section mt-3">
                                        <div className="comment-box d-flex align-items-center p-2">
                                            <Avatar alt="Remy Sharp" sx={{ width: 40, height: 40, marginRight: 2 }} className='me-3' src={post.avatarUrl} />
                                            <TextField
                                                variant="outlined"
                                        ...
                                        <div className="comments-list px-5 mt-3">
                                            {post.comments.length > 0 ? post.comments.map((comment, commentIndex) => (
                                                <div key={commentIndex} className="d-flex mb-2 text-black">
                                                    <Avatar alt="User Avatar" sx={{ width: 30, height: 30 }} className='me-2' src={post.avatarUrl} />
                                                    <p className="mb-0 text-black p-2 rounded-3" style={{ backgroundColor: "#e0e0e0" }}>{comment}</p>
                                                </div>
