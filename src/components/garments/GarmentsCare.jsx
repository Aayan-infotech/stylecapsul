...
const GarmentsCare = () => {
    ...
    useEffect(() => {
        const fetchUserData = async (query = "") => {
            try {
                const url = query ? apiUrl(`api/garment/garment-care/services/${query}`) : apiUrl('api/garment/garment-care');
                            ...
                            style={{cursor:'pointer'}}
                                ...
                                <div
                                    ...
                                    <div className="p-2 text-white">
                                        ...
                                        <h6 className="mt-4"><i className="fa-solid fa-location-dot me-2"></i>{garment.ServiceProvider.address}</h6>
                                    </div>
                                </div>
                            </div>
                        ))
