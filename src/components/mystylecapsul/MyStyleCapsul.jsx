        ...
        <div className="mt-1" style={{ display: "flex", flexDirection: "column", alignItems: "center", }}>
          <div className="row m-0 gx-5">
            <div className="col inner-img">
              <img src={capsulimg} style={{ position: "relative" }} alt="Capsule Left" />
              <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", }}>
                <div data-bs-toggle="modal" data-bs-target="#openCalendarDialogCurrent">
                  <img style={{ marginLeft: "4rem" }} src={blankimage} height={50} width={50} alt="No Image" />
                  <br />
                  <br />
                  <h6 style={{ marginLeft: "2rem" }} className="fs-6 text-center mt-2">
            ...
            <div className="col inner-img">
              <img src={capsulimg} style={{ position: "relative" }} alt="Capsule Middle" />
              {middleColumnData.length === 0 ? (
                ...
                middleColumnData.map((image, imageIndex) => (
                  <Link key={imageIndex} to={image.url}>
                    <div key={imageIndex} style={{ position: "absolute", top: image.top, right: image.right, }}>
                      <img src={image.src} width={200} alt={`Image ${imageIndex}`} />
                    </div>
                  </Link>
                ))
              )}
            ...
            <div className="col inner-img">
              <img src={capsulimg} style={{ position: "relative" }} alt="Capsule Right" />
              <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", }}>
                <div data-bs-toggle="modal" data-bs-target="#openCalendarDialogCurrent">
                  <img style={{ marginLeft: "4rem" }} src={blankimage} height={50} width={50} alt="No Image" />
                  <br />
          ...
          <div className="border-bottom w-100 mt-4">
            <div className="border-bottom w-100 mt-4">
              <div className="d-flex justify-content-end align-items-center text-black">
                <h5 style={{ cursor: capsuleId ? "pointer" : "not-allowed", position: "relative", opacity: capsuleId ? 1 : 0.5, }} onClick={capsuleId ? handleExploreShare : null} className="me-3">
                  {isLoadingExplore ? (
                ...
                <h5 style={{ cursor: capsuleId ? "pointer" : "not-allowed", position: "relative", opacity: capsuleId ? 1 : 0.5, }} onClick={capsuleId ? handleInstagramShare : null}>
                  {isLoadingInstagram ? (
                    <span className="loading-text">
                      <i className="fa-solid fa-spinner fa-spin me-2"></i>{" "}
                      Opening...
